...
/*********************************************************************************************************************** SPI int the ATmega32A *****************************************************************************************************************/

#define SPSR_ADDRESS  (0x0E)
#define SPCR_ADDRESS  (0x0D)
#define SPDR_ADDRESS  (0x0F)

/* The Mapped Address of the SPI Control Register */
#define SPCR     (*(volatile uint8 *)(SPCR_ADDRESS + IO_MAPPED_OFFSET))

/* SPCR Bits */
#define SPR0     (0)  /* SPI Clock rate Select */
#define SPR1     (1)  /* SPI Clock rate Select */
#define CPHA     (2)  /* SPT Clock Polarity bit */
#define CPOL     (3)  /* SPT Clock Functionality bit */
#define MSTR     (4)  /* Master Slave Select Bit */
#define DORD     (5)  /* Data order LSB / MSB bit Select */
#define SPE      (6)  /* SPI Enable bit */
#define SPIE     (7)  /* SPI Interrupt Enable bit */

/* The Mapped Address Of the SPI Statues Register */
#define SPSR     (*(volatile uint8 *)(SPSR_ADDRESS + IO_MAPPED_OFFSET))

/* SPSR Bits */
#define SPI2X   (0) /* Double SPI Speed Bit */
#define WCOL    (6) /* Write Collision Flag */
#define SPIF    (7) /* Interrupt Falg */

/* The Mapped Address Of the SPI Data Register */
#define SPDR     (*(volatile uint8 *)(SPDR_ADDRESS + IO_MAPPED_OFFSET))
